test:all.c linked_list.c operation.c mutex.c rwlock.c serial_program.c 
	gcc -g -o all all.c linked_list.c operation.c mutex.c rwlock.c serial_program.c -lpthread -lm -O3
